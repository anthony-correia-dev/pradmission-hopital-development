...
export const H1 = forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ className, color, ...props }, ref) => (
    <h1 ref={ref} className={cn(color && colorMap[color], className)} {...props} />
  ),
)
H1.displayName = 'H1'
...
export const H2 = forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ className, color, ...props }, ref) => (
    <h2 ref={ref} className={cn(color && colorMap[color], className)} {...props} />
  ),
)
H2.displayName = 'H2'
...
export const H3 = forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ className, color, ...props }, ref) => (
    <h3 ref={ref} className={cn('form-section-title', color && colorMap[color], className)} {...props} />
  ),
)
H3.displayName = 'H3'
...
export const H4 = forwardRef<HTMLHeadingElement, TypographyProps>(
  ({ className, color, ...props }, ref) => (
    <h4 ref={ref} className={cn('font-medium', color && colorMap[color], className)} {...props} />
  ),
)
H4.displayName = 'H4'
...
export const P = forwardRef<HTMLParagraphElement, ParagraphProps>(
  ({ className, color, size, ...props }, ref) => (
    <p ref={ref} className={cn(size && sizeMap[size], color && colorMap[color], className)} {...props} />
  ),
)
P.displayName = 'P'
