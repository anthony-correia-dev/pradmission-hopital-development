export const loadingTranslations = {
  fr: {
    ...
    ocrTimeout: 'La reconnaissance de vos documents n\'a pas abouti. Veuillez vérifier et compléter les informations manuellement.',
  ...
  en: {
    ...
    ocrTimeout: 'Document recognition was not successful. Please verify and complete the information manually.',
